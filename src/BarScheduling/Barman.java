...
public class Barman extends Thread {
	...
	private Comparator<DrinkOrder> drinkOrderComparator = new Comparator<DrinkOrder>() {
        @Override
	...
	Barman(  CountDownLatch startSignal,int schedAlg) {
		...
		//FIX below 
		else {    this.orderQueue = new PriorityBlockingQueue<DrinkOrder>(2, drinkOrderComparator);;
